...
/**
 * Drop the placeholders the complaints endpoint emits where the complainant gave no incident
 * date, and nothing else. Matching the placeholder values themselves rather than a date floor
 * keeps genuine 1970s and 1980s incidents — a complaint about a 1986 vehicle can carry a 1989
 * incident date. `dateComplaintFiled` is generated by NHTSA on receipt, never a placeholder,
 * so it deliberately skips this rule.
 */
